...
if (!$ARGV[0]) {
	...
	print "
This web service allows a remote user to access the climdb_agg table from OSU's CLIMHY database. See xxx for more documentation.
