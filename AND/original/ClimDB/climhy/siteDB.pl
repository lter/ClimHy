...
sub draw_page3{
	...
	if ($use eq 'Confirmation') {
		...
		print ("\n\nWould you like to return to the <A HREF='http://www.fsl.orst.edu/climhy/harvest/harvest.htm'>participant page</A>?<BR><HR>\n"); 

	} elsif ($use eq 'Update') {
		print ("\n\nWould you like to return to the <A HREF='http://www.fsl.orst.edu/climhy/harvest/harvest.htm'>participant page</A>?<BR><HR>\n"); 
	} elsif ($use eq 'Report') {
		print ("\n\nWould you like to return to the <A HREF='http://www.fsl.orst.edu/climhy/'>data access page</A>?<BR><HR>\n"); }
