...
#JAMES EDITED
	my $XSL = "$Bin/lib/LTERmeta2fo.xsl";
	my $XML = "$Bin/temp/LTERmetadata.xml";
#JAMES converted to unix directory notation
	open XML, ">$XML" or die "Can't open $XML\n$!";

	my $site = &page1();
	my $PDF = "$Bin/temp/$site.pdf";
#JAMES converted to unix diretory notation
